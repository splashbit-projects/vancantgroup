export const pricingIt = [
    {
        ...
        <li>Configurazione dei social media: Creazione e ottimizzazione del profilo sulle principali piattaforme</li>
        <li>SEO: Ricerca delle parole chiave, ottimizzazione on-page, audit tecnico SEO</li>
        <li>PR: Scrittura e distribuzione di comunicati stampa, contatti con i media, menzioni del marchio</li>
        <li>Configurazione dell'email marketing: Creazione di elenchi, progettazione di modelli, configurazione iniziale della campagna</li>
        </ul>`,
        price: `A partire da 45.000 EUR*`,
    },
    {
        id: 2,
        title: "Lanciato",
        ...
        <li>Gestione dei social media: Creazione di contenuti, programmazione, coinvolgimento</li>
        <li>Partnership con influencer: Identificazione e collaborazione con influencer rilevanti</li>
        <li>Campagne di email marketing: Sviluppo di strategie, creazione di contenuti, configurazione dell'automazione</li>
        </ul>`,
        price: `A partire da 50.000 EUR*`,
    },
    {
        id: 3,
        title: "Consolidato",
        ...
        <li>Generazione di lead: Creazione di landing page, sviluppo di lead magnet</li>
        <li>Gestione della reputazione: Monitoraggio e risposta alle recensioni online, comunicazione di crisi</li>
        <li>Analisi e reportistica: Monitoraggio e analisi regolare delle prestazioni</li>
        </ul>`,
        price: `A partire da 60.000 EUR*`,
    },
    {
        id: 4,
        title: "Competitivo",
        ...
        <li>Posizionamento strategico: Differenziazione del marchio, strategie di posizionamento sul mercato</li>
        <li>SEO avanzato: Ottimizzazione tecnica, ricerca avanzata delle parole chiave</li>
        <li>Opportunità di partnership: Identificazione e sfruttamento delle partnership strategiche per la crescita</li>
        </ul>`,
        price: `A partire da 70.000 EUR*`,
    },
];
